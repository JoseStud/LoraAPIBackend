...
export const createGenerationFacade = ({
  ...
  transportPaused: manager.transportPaused,
  transportPauseReasons: manager.transportPauseReasons,
  transportPauseSince: manager.transportPauseSince,
  transportLastPauseEvent: manager.transportLastPauseEvent,
  transportLastResumeEvent: manager.transportLastResumeEvent,
