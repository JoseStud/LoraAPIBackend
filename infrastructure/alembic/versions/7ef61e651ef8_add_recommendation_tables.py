...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "recommendation_type", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.Column(
            "preference_type", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "preference_value", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "recommended_lora_id", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
...
def downgrade():
    ...
    with op.batch_alter_table("deliveryjob", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("idx_deliveryjob_status"), ["status"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_deliveryjob_mode"), ["mode"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_deliveryjob_created_at"), ["created_at"], unique=False
        )

    with op.batch_alter_table("adapter", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("idx_adapter_ordinal"), ["ordinal"], unique=False
        )
        batch_op.create_index(batch_op.f("idx_adapter_name"), ["name"], unique=False)
        batch_op.create_index(
            batch_op.f("idx_adapter_created_at"), ["created_at"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_adapter_active_ordinal"),
            ["active", "ordinal"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_adapter_active"), ["active"], unique=False
        )
