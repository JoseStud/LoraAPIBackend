...
def upgrade():
    ...
    with op.batch_alter_table("adapter", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column(
                "primary_file_name", sqlmodel.sql.sqltypes.AutoString(), nullable=True
            )
        )
        batch_op.add_column(
        ...
        batch_op.add_column(
            sa.Column(
                "primary_file_sha256", sqlmodel.sql.sqltypes.AutoString(), nullable=True
            )
        )
        batch_op.add_column(
            sa.Column(
        ...
        batch_op.add_column(
            sa.Column(
                "supports_generation", sa.Boolean(), nullable=False, server_default="0"
            )
        )
        batch_op.add_column(
        ...
        batch_op.alter_column(
            "tags", existing_type=sa.VARCHAR(), type_=sa.JSON(), existing_nullable=True
        )
