            ...
            while True:
                try:
                    ...
                    if msg_type == "connected":
                        ...
                        print(f"   Subscribed to: {data['data']['job_ids'] or 'all jobs'}")
                        ...
                        if complete_data.get("images"):
                            print(f"   Images: {len(complete_data['images'])} generated")
...
if __name__ == "__main__":
    ...
    print("💡 To test, start the server and create a generation job in another terminal:")
